  ...
  documents: [
    {
      ...
      date: "2026-08-01",
      dueDate: "2026-08-10",
      lineItems: [{ id: "li1", description: "Arbeit", qty: "7.5", unit: "h", unitPrice: "85" }],
      vatRate: 8.1,
      status: "open",
      notes: "",
    },
    {
      ...
      number: "O-2026-001",
      date: "2026-08-05",
      lineItems: [{ id: "li2", description: "Offerte", qty: "1", unit: "", unitPrice: "500" }],
      vatRate: 8.1,
      status: "sent",
      notes: "",
    },
  ],
  assignments: [{ id: "a1", date: new Date().toISOString().slice(0, 10), projectId: "p1", userId: "u1" }],
  reports: [
    {
      id: "r1",
      projectId: "p1",
      ...
      userId: "u2",
      hours: "7.5",
      lines: [{ description: "Siga Risan", qty: "8", unit: "m" }],
      note: "",
      signerName: "Frau Sutter",
      signatureId: "sig1",
      signedAt: Date.now(),
      createdAt: Date.now(),
    },
  ],
  leave: [{ id: "l1", date: "2026-08-27", userId: "u2", type: "vacation", note: "", status: "pending" }],
};

let roleValue = "owner";
export function setStubRole(r) {
  roleValue = r;
}
...
export function canManage() {
  return roleValue === "owner" || roleValue === "supervisor";
}
...
export async function listInvites() {
  return [{ code: "ABCD2345", expiresAt: Date.now() + 86400000 }];
}
...
export async function personalDataSummary() {
