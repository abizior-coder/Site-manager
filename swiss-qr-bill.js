// Swiss QR-bill (QR-Rechnung) payload generation, loaded when a bill is
// printed. See swiss-qr.js for the validation the form needs first.
//
...
import { normaliseIban } from "./swiss-qr.js";
