...
export function BoardTab({ assignments, boardView, calMonth, customers, dragProject, entries, lang, leaveRequests, openBranch, printRapport, projects, setAssignModal, setBoardView, setCalMonth, setDragProject, setOpenBranch, setSelectedProject, setShowFinishedJobs, setTab, setWeekAnchor, showFinishedJobs, siteReports, t, team, toggleAssignment, weekAnchor, weekDays }) {
